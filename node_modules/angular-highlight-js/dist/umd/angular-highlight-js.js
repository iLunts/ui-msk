(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["angularHighlightJs"] = factory(require("@angular/core"));
	else
		root["angularHighlightJs"] = factory(root["ng"]["core"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var highlightJs_directive_1 = __webpack_require__(3);
	var highlightJs_token_1 = __webpack_require__(4);
	var HighlightJsModule = (function () {
	    ...
	    HighlightJsModule.forRoot = function (hljs) {
	        return {
	            ...
	            providers: [{
	                    provide: highlightJs_token_1.HIGHLIGHT_JS,
	                    ...
	                    useValue: { highlight: function (language, source) { return hljs.highlight(language, source); } }
	                }]
	        };
	    };
	    HighlightJsModule = __decorate([
	        core_1.NgModule({
	            declarations: [highlightJs_directive_1.HighlightJsDirective],
	            exports: [highlightJs_directive_1.HighlightJsDirective]
	        }), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HighlightJsDirective = (function () {
	    ...
	    ], HighlightJsDirective.prototype, "source", void 0);
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', String)
	    ], HighlightJsDirective.prototype, "language", void 0);
	    HighlightJsDirective = __decorate([
	        ...
	        __param(0, core_1.Inject(highlightJs_token_1.HIGHLIGHT_JS)), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var core_1 = __webpack_require__(2);
	exports.HIGHLIGHT_JS = new core_1.OpaqueToken('highlight.js');
